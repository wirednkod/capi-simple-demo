...
window.onload = () => {
    ...
    void (async () => {
        try {
            ...
            ui.showSynced();
            ui.log(`${emojis.seedling} Chain is ready (powered by CAPI) - Reading at block #${parseInt(currentBlock.block.block.header.number, 0)}`, true);
            ...
            ui.log(`${emojis.stethoscope} Chain is syncing with ${health.peers}`);
